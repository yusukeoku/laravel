<div class="flex mb-4" x-data="picturePreview()">
    <div class="mr-3">
        <img
             id="preview"
             src="{{ isset(Auth::user()->imagecheck_path) ? asset('storage/' . Auth::user()->imagecheck_path) : asset('images/user_icon.png') }}"
             alt=""
             class="w-300 h-300 object-contain border bg-gray-200">
    </div>
