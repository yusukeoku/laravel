<div class="flex mb-4" x-data="picturePreview()">
    <div class="mr-3">
        <img
             id="preview"
             src="<?php echo e(isset(Auth::user()->image_check_path) ? asset('storage/' . Auth::image_check()->image_check_path) : asset('images/user_icon.png')); ?>"
             alt=""
...
<?php /**PATH /Applications/MAMP/htdocs/laravel/resources/views/components/check-image-input.blade.php ENDPATH**/ ?>