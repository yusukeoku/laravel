<div class="flex mb-4" x-data="picturePreview()">
    <div class="mr-3">
        <img
             id="preview"
             src="<?php echo e(isset(Auth::user()->profile_photo_path) ? asset('storage/' . Auth::user()->profile_photo_path) : asset('images/user_icon.png')); ?>"
             alt=""
...
<?php /**PATH /Applications/MAMP/htdocs/laravel/resources/views/components/picture-input.blade.php ENDPATH**/ ?>