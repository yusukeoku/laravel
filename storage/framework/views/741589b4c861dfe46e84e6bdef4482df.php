...
<?php endif; ?>
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                ...
                <span class="ml-2 text-sm text-gray-600 dark:text-gray-400"><?php echo e(__('入力を保存する')); ?></span>
            </label>
        </div>
...
<?php endif; ?>
<?php /**PATH /Applications/MAMP/htdocs/laravel/resources/views/auth/login.blade.php ENDPATH**/ ?>